...
- `PROJECT_OVERVIEW_GITHUB.md`
  - proposed public README overview
- `README_PUBLIC_FINAL.md`
  - copy-ready public README draft
- `CONTRIBUTING_GITHUB.md`
  - proposed public contributing guide
- `SECURITY_GITHUB.md`
...
- `REPOSITORY_OVERHAUL_CHECKLIST.md`
  - migration checklist
- `LAUNCH_RUNBOOK.md`
  - launch-day sequence and verification gates
- `PUBLIC_REPO_BOOTSTRAP.md`
