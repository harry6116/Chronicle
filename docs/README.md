...
This documentation tree is organized by audience and purpose.

## Main sections

- `docs/public/` contains public-safe product summaries, reusable blurbs, and outward-facing positioning material.
...
- Product overview: `docs/public/WHY_CHRONICLE.md`
- User guide: `docs/user/chronicle_help.html`
